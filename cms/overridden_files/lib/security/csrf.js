...
exports.getSecret = function(req) {
	return (
		...
		(req.session[exports.SECRET_KEY] = exports.createSecret())
	);
};

exports.createToken = function(req) {
	return tokenize(
		utils.randomString(exports.SECRET_LENGTH),
		exports.getSecret(req)
	);
};

exports.getToken = function(req, res) {
	res.locals[exports.LOCAL_VALUE] =
		res.locals[exports.LOCAL_VALUE] || exports.createToken(req);
