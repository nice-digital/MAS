...
namespace MAS.Controllers
{
    ...
    public class MailController : ControllerBase
    {
        ...
        public MailController(IMailService mailService, IContentService contentService, IViewRenderer viewRenderer, ILogger<MailService> logger, MailConfig mailConfig)
        {
